...
#include "arm_solutions/HeliosSolution.h"
...
#define  helios_checksum                     CHECKSUM("helios")
...
void Robot::load_config()
{
    ...
    } else if(solution_checksum == helios_checksum) {
        this->arm_solution = new HeliosSolution(THEKERNEL->config);
